...
<<<<<<< HEAD
	...
	/*
	 * Pause transition function and set new elements Shows the spinning and next
	 * screen selected
	 */
	...
	public static void SetElement(final BorderPane borderA, final BorderPane borderB) {
		borderA.getChildren().setAll(borderB);
	}
